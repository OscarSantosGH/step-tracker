...
struct StepPieChart: View {
    @State private var rawSelectedChartData: Double? = 0.0
    @State private var lastSelectedValue: Double = 0.0
    ...
    var body: some View {
        ChartContainer(chartType: .stepWeekdayPie) {
            ...
            .chartAngleSelection(value: $rawSelectedChartData)
            .onChange(of: rawSelectedChartData) { oldValue, newValue in
